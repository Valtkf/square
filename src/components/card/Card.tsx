...
export default function Card() {
  return (
    <div className="flex justify-center gap-x-8 mt-20 flex-wrap">
      <SlideInAnimation direction="right">
        <div className="mb-10 p-8 flex flex-col justify-between items-start border border-[#3E3E3E] border-opacity-15 w-full max-w-md h-auto rounded-[20px] bg-slate-300 bg-opacity-20 sm:max-w-sm">
          ...
          <button className="w-full max-w-[432px] sm:max-w-[100%] text-lg font-regular text-white bg-[#F2B53C] hover:bg-[#ffc756] duration-200 h-[56px] rounded-3xl">
            Try for Free
          </button>
        </div>
      </SlideInAnimation>
      ...
      <SlideInAnimation direction="left">
        <div className="p-8 flex flex-col justify-between items-start border border-[#F2B53C] w-full max-w-md h-[708px] rounded-[20px] bg-slate-300 bg-opacity-20 sm:max-w-sm">
          <div className="flex-grow">
